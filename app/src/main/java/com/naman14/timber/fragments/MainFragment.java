...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {//建立該fragment對應的ui
        ...
        Toolbar toolbar = (Toolbar) rootView.findViewById(R.id.toolbar);//呼叫fragament_main.xml的toolbar, UI: Music Creater 那行;
    ...
    static class Adapter extends FragmentPagerAdapter {
        ...
        @Override
        public CharSequence getPageTitle(int position) {//get該位置的fragament的title
